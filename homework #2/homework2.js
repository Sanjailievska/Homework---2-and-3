...
if (inputYear) {
  ...
  console.log(" If you were born in " + inputYear + " your Chinese Zodiac sign is the " + zodiac);
  alert(" If you were born in " + inputYear + " your Chinese Zodiac sign is the " + zodiac);
} else {
